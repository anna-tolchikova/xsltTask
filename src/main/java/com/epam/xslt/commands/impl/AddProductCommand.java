...
public class AddProductCommand extends BaseCommand implements ICommand {

	private final static Logger log = Logger.getLogger(AddProductCommand.class);
	...
	public void execute(HttpServletRequest req, HttpServletResponse resp)
		...
		String xslPath = req.getServletContext().getRealPath(
				Constants.XSL_ADD_PRODUCT_PATH);
